...
/**
 * Security: Remove author information from oEmbed responses to prevent enumeration.
 */
function lieuwe_remove_oembed_author( $data ) {
    unset( $data['author_name'], $data['author_url'] );
    return $data;
}
add_filter( 'oembed_response_data', 'lieuwe_remove_oembed_author' );
