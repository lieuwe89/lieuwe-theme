...
/**
 * Security: Prevent user enumeration via oEmbed response data.
 *
 * WordPress oEmbed responses include author_name and author_url which can be
 * used to enumerate usernames. This removes those fields from the response.
 */
function lieuwe_remove_oembed_author_data( $data, $url, $args ) {
...
add_filter( 'oembed_response_data', 'lieuwe_remove_oembed_author_data', 10, 3 );
