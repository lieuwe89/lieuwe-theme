...
/**
 * Security: Remove author data from oEmbed response to prevent user enumeration.
 *
 * The WordPress oEmbed API endpoint returns author information for posts,
 * which can be used to enumerate users even if author archives are disabled.
 */
