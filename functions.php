...
/**
 * Security: Remove author info from oEmbed response to prevent user enumeration.
 *
 * @param array $data The oEmbed response data.
 * @return array Modified oEmbed response data.
 */
function lieuwe_disable_oembed_author( array $data ): array {
...
add_filter( 'oembed_response_data', 'lieuwe_disable_oembed_author' );
