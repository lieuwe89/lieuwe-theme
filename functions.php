...
/**
 * Security: Remove author details from oEmbed responses to prevent user enumeration.
 *
 * WordPress oEmbed API returns author name and URL by default, which can be
 * used to enumerate users even if REST API and query strings are blocked.
 */
